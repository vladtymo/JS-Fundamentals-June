...
console.log(document.querySelector('ul.base-list li.important')); // get single element
console.log(document.querySelectorAll('ul.base-list>li:nth-child(even)')); // get collection of element
